...
import customSeleniumUtils.enums.WaitFor;
...
public class Page {
    ...
    private int waitForDefaultTime;
    private final WebDriverWait driverWait;

    public Page(AppSession appSession){
        driver = appSession.getDriverManager().getDriver();
        this.waitForDefaultTime = appSession.getDefaultTimeout();
        driverWait = new WebDriverWait(driver, Duration.ofSeconds(waitForDefaultTime));
    }
    ...
    public WebElement element(By byLocator, WaitFor waitForCondition) {
        return element(byLocator, waitForCondition, waitForDefaultTime);
    }
    ...
    public WebElement waitForElementToExist(By byLocator) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitForDefaultTime));
    ...
    public WebElement waitForElementToBeVisible(By byLocator) {
        return waitForElementToBeVisible(byLocator, waitForDefaultTime);
    }
    ...
    public void waitForElementToBeInvisible(By byLocator) {
        waitForElementToBeInvisible(byLocator, waitForDefaultTime);
    }
    ...
    public void waitForElementToBeClickable(By byLocator) {
        waitForElementToBeClickable(byLocator, waitForDefaultTime);
    }
    ...
    public void switchToLastWindowInHandles() {
        ...
        try{
            ...
            System.out.println("Current app window is now closed.");
        }
